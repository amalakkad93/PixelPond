...
const ImageDisplay = ({ mode, albumId }) => {
  ...
  console.log("🚀 ~ file: index.js:49 ~ albumImages:", albumImages)
  // const {images, title} = useSelector((state) => selectAlbumImages(state, albumId));
  const sessionUser = useSelector(selectSessionUser);
  const userPosts = useSelector(selectUserPosts);
  console.log("🚀 ~ file: index.js:51 ~ userPosts:", userPosts)
  const userPostsIds = useSelector(selectPostById);
  console.log("🚀 ~ file: index.js:53 ~ userPostsIds:", userPostsIds)
